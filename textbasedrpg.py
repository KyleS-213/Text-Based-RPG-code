...
global Engaged
Engaged = None
Goblin = Enemy('Goblin',0,0,'sometin broke', 15, "This hulking greenish brute has four fingers and is dressed in a simple loincloth. It brings with it the smell of rot and mold")
Road = Room('Road','The road is made of a dry, yellowish dirt. The road is hard packed from decades of use.')  
...
if Doublecheckname == "Yes":
    print("Splendid, now as you can see, we are in a bit of a pickle. There are a few goblins planning to eat us. Please take a weapon and defend the village")
    chooseweapon = input("I have a Common Dagger and a Common Sword, which would you like")
